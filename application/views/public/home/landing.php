...
<header>
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in">Hello Fellow Indian!</div>
            <div class="intro-heading">You got a responsibility</div>
            <div class="intro-lead-in">To bring a change in the society!</div>
            <a href="#services" class="page-scroll btn btn-xl">Learn How</a>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">You got to do just the first!</h3>
            </div>
        </div>
